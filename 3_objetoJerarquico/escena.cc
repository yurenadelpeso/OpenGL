...
Escena::Escena()
{
    ...
    //plyrev = new ObjRevolucion("./plys/ant.ply", num_instancias_perf);
    
    objJerarquico=new ObjJerarquico();
    //examenJerarquico=new ObjJerarquico();

    cupula=new Cupula(8, num_instancias_perf);


    objeto_actual = 7;
    num_objetos = 8; //NUMERO DE OBJETOS DEL CATALOGO
    num_modos = 4; //MODOS DE DIBUJO
...
/*****************************************************************************
  ...
  case 7:
       if ( objJerarquico != nullptr ){
          cout<<"entrando a JERARQUICO \n";
          cout << "num rev de mi objeto revolucion == " << num_instancias_perf << endl ;
          objJerarquico->draw(modo,ajedrez);           
       }
    break ;
...
bool Escena::teclaPulsada( unsigned char tecla, int x, int y )
{
   ...
   switch( tecla )
   {
      ...
      case 'N':
        cout<<"CASE LETRA N, AUMENTANDO REVOLUCIONES"<<endl;
        num_instancias_perf=num_instancias_perf+6;
      break; 

      case 'B':
        cout<<"CASE LETRA B, DISMINUCION REVOLUCIONES  "<<endl;
        num_instancias_perf=num_instancias_perf-6;
      break; 
      
      case 'P':
        cout<<"CASE LETRA P, SIGUIENTE PARAMETRO  "<<endl;
        objJerarquico->siguienteParametro();
      break; 

      case 'A':
        cout<<"CASE LETRA A, ANIMACIONES   "<<endl;
        conmutarAnimaciones();
      break; 

      case 'Z':
        cout<<"CASE LETRA Z, AUMENTANDO PARAMACTO   "<<endl;
      ...
      case '>':
        cout<<"CASE >, AUMENTANDO REVOLUCIONES"<<endl;
