...

{
   ...
   public:
      ...
      void crearMallaSinTapas( const std::vector<Tupla3f> & perfil,int instanciasPerfil ) ;
...
class OtroCuadro : public ObjMallaIndexada{
   public:
      OtroCuadro(const std::string &nombre_archivo, const std::vector<Tupla2f> textura_vertices);
};
